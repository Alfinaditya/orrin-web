...
Kualitas merupakan pijakan utama yang dipegang teguh oleh Orrin Parfume. Dengan berbekal pengetahuan
        ...
        <div style="display:flex;align-items: center;margin-top:80px">
                ...
                <div style="margin-left:100px">
                    <h1>SEGERA HADIR!</h1>
                        <p>"Bomshell" Aroma menggoda yang membuat semua orang tergila-gila. Segera hadir, campuran menakjubkan ini akan memikatmu dengan daya tarik misterius dan pesona yang memabukkan.
                        </br></br>Bersiaplah untuk terhanyut oleh kekuatan ledakan bahan rahasia kami, karena Bomshell akan membawa Anda dalam perjalanan olfaktori yang tak terlupakan. Tunggu peluncuran yang akan mengguncang dunia.
            </p>
                </div>
