...
@section('content')
    <div id="about" style="width:90%;margin:auto;margin-bottom:100px;padding-top:120px">
        <h1 class="text-center" style="margin-bottom:10px">ABOUT ORRIN PARFUME</h1>
        <div style="display:flex;align-items: center;">
            <p style="margin-right:100px">Orrin Parfume brand lokal Surabaya yang didirikan pada akhir tahun 2021. Misi utama
                Orrin Parfume adalah menyediakan parfum berkualitas tinggi dengan menggunakan bahan-bahan terbaik dan harga
                yang terjangkau.
