    ...
    <div>
        ...
        <a style="text-decoration:none;color:white" href="https://wa.me/+6285232905378" target="_blank"
            ...
            <div style="margin-bottom:40px;display:flex;">
                ...
                <p style="margin-left:10px">+6285232905378</p>
            </div>
        </a>

        <div style="display:flex;">
            <h4 style="margin-right:20px;">Follow Us : </h4>
            <div style="margin-right: 20px;">
                <a style="text-decoration:none;color:white" href="https://www.instagram.com/orrinofficial"
            ...
            <div>
                <a style="text-decoration:none;color:white " href="https://www.instagram.com/orrinofficial"
                    target="_blank" rel="noopener noreferrer">
                    <a style="text-decoration:none;color:white " href="https://shp.ee/s8752yt" target="_blank"
                        rel="noopener noreferrer">
                        <svg fill="white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="30px"
                            height="30px">
                            <path
