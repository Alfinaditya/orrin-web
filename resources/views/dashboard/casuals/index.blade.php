    ...
    <div class="container">
        <div class="">
            <div class="col my-3 d-flex justify-content-start">
                <a href="/dashboard/casuals/create" class="btn btn-primary btn-sm py-1"><span data-feather="plus-circle" style="width: 18px; height: 18px;"></span>Tambah
                    Data</a>
            </div>
        </div>
    </div>
            ...
            , {
                ...
                , render: function(data) {
                    return `
                        ...
                        <a href="/dashboard/casuals/${data}/edit" class="badge bg-warning"><span data-feather="edit" class="align-text-bottom"></span></a>
                        <a href="/dashboard/casuals/${data}" class="badge bg-danger" onclick="return confirm('Hapus Data?')"><span data-feather="x-circle" class="align-text-bottom"></span></a>
                        `
                }
